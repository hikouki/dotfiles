...
(defvar all-the-icons-icon-alist
  '(
    ...
    ("\\.tsx$"          all-the-icons-fileicon "tsx"                    :height 1.0 :v-adjust -0.1 :face all-the-icons-blue-alt)
...
(define-obsolete-function-alias 'define-icon 'all-the-icons-define-icon "1.0.0")
